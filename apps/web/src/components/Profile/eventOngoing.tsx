...
export default function EventOngoing() {
    return (
        <div>
            <div id="EventOnGoing" className="w-full bg-primary pt-10 pb-10">
                        ...
                        <div className="bg-gradient-to-t from-indigo-950 to-gray-500 rounded-xl overflow-hidden shadow-lg mb-10">
                            ...
                            <div className="py-12 px-6">
                                ...
                                <div className="flex gap-5 justify-center pt-3">
                                    <Link href="/" className="text-secondary py-3 px-5 pb-3 rounded-xl border border-solid border-secondary hover:bg-gradient-to-l from-third to-primary transition duration-300 ease-in-out">View Ticket</Link>
                                </div>
                            </div>
                        </div>
                    </div>
