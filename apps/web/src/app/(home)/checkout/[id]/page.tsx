...
export default function Checkout() {
      ...
      const finalprice = data[0]?.price! * initialValues.quantitiy
                        ...
                        <div className="flex flex-col sm:flex-row  justify-evenly">
                              <div className="mt-5 p-5 sm:w-[350px] lg:w-[600px]" >
                                    ...
                                    <div>
                                          ...
                                          <Formik
                                                ...
                                                onSubmit={(values) => {
                                                      alert(`${values.quantitiy}, ${values.voucherdiscount}, ${values.point}, ${values.price}, ${values.finalprice}`)
                                                      console.log(values);
                                                }}
                                          >
                              ...
                              <div className="flex flex-col gap-5 lg:border-l w-[410px] p-10 mt-10 h-[700px]">
                                    ...
                                    <div className="grid grid-cols-2 gap-5 items-center">
                                          ...
                                          <p className="text-white text-right">{data[0]?.price}</p>
