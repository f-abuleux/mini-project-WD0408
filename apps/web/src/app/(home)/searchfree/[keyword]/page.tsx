...
const SearchPageFree = ({ params }: SearchPageProps) => {
    ...
    const fetchingData = async (event: string) => {
        try {
            const respon = await fetch(`http://localhost:8000/api/event/events/free?search=${event}`)
