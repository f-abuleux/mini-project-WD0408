...
import { registerUser } from "@/libs/action/organizer";

const signUpSchema = yup.object().shape({
      usernameCreator: yup.string().required("username is required"),
      email: yup
            .string()
...
export default function SignUpOrganizer() {
      const [user, setUser] = useState<ISignUpOrganizer | null>(null);
